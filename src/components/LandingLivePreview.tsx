...
export function LandingLivePreview({
  ...
  return (
    <aside className="flex flex-col gap-3 lg:sticky lg:top-6">
      ...
      {/* ~iPhone-class portrait: 9 : 19.5; max height keeps it on screen */}
      <div className="flex justify-center">
        <div className="mx-auto w-[min(320px,calc(100vw-2rem))] max-h-[min(92vh,820px)] shrink-0 overflow-hidden rounded-[2.25rem] border border-zinc-200 bg-zinc-950 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.35)] ring-1 ring-black/5 [aspect-ratio:9/19.5]">
